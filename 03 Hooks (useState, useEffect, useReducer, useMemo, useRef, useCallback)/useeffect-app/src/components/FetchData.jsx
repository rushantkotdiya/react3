...
import imgLoader from "../loader2.gif";
    ...
    <div>
      <div className="container p-5 mt-5">
        ...
        <h2>
          ...
          <button
            type="button"
            className="ms-5 btn btn-sm btn-danger float-end"
          >
            Export Data
          </button>
        </h2>
                ...
                <>
                  <tr>
                    ...
                    <td>
                      <a
                        href=""
                        className="btn btn-danger text-white bg-danger fs-6"
                      >
                        Delete
                      </a>
                      |
                      <a
                        href=""
                        className="btn btn-danger text-white bg-primary fs-6"
                      >
                        Edit
                      </a>
                    </td>
